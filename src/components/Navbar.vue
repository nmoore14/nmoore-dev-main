<template>
  <nav class="flex absolute md:fixed w-full items-center justify-end md:justify-between flex-wrap bg-steel-500 p-4 z-50">
    <div class="block lg:hidden">
      <button class="flex items-center px-3 py-2 mb-4 right-0 border rounded text-white border-white hover:text-white hover:border-white">
